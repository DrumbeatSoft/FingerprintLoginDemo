...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public final static String IV_STR_SP_KEY = "iv_str_sp_key";
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.tv_finger_login:
                if (!TextUtils.isEmpty(SPUtils.getInstance().getString(IV_STR_SP_KEY))) {
                    fingerLogin();
                } else {
            ...
            mManager.authenticate(true, new BiometricPromptManager.OnBiometricIdentifyCallback() {
                ...
                public void onSucceeded(FingerprintManager.AuthenticationResult result) {
                    try {
                        ...
                        String ivBase64Encode = Base64.encodeToString(iv, Base64.URL_SAFE);
                        Log.i("test", "IV: " + ivBase64Encode);
            ...
            mManager.authenticate(false, new BiometricPromptManager.OnBiometricIdentifyCallback() {
                ...
                public void onSucceeded(FingerprintManager.AuthenticationResult result) {
                    try {
                        ...
                        byte[] iv = cipher.getIV();
                        String ivBase64Encode = Base64.encodeToString(iv, Base64.URL_SAFE);
                        SPUtils.getInstance().put(IV_STR_SP_KEY, ivBase64Encode);
                        Log.i("test", "设置指纹时保存的加密IV: " + ivBase64Encode);
